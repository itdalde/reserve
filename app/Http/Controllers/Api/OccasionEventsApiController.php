...
class OccasionEventsApiController extends Controller
{
    ...
    {
        $occasions = OccasionEvent::with('company', 'paymentPlan', 'occasionEventsReviews', 'occasionEventsReviewsAverage', 'gallery', 'adOns')
    ...
    public function getOccasionByServiceType(EventsByEventTypeRequest $request): JsonResponse
    {
        ...
        $occasions = OccasionEvent::with('company', 'occasionEventsReviews', 'paymentPlan', 'occasionEventsReviewsAverage', 'gallery', 'adOns')
    ...
    {
        $event = OccasionEvent::with('company', 'paymentPlan', 'occasionEventsReviews', 'occasionEventsReviewsAverage', 'gallery', 'adOns')
