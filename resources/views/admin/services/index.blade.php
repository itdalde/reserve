                        ...
                        <table class="table w-100" id="myTable">
                            ...
                            <tbody>
                                @foreach ($services as $service)
                                    <tr style="cursor: pointer;" data-available-slot="{{ $service->availability_slot }}"
                                    ...
                                    @endforeach @endif
                                        ...
                                        data-occasion-types="{{ $occasionHolder }}" data-images="{{ $imagesHolder }}"
                            ...
                            <div class="d-flex flex-column bd-highlight mb-3">
                                <div class="p-2 bd-highlight ">
                                    ...
                                    <input dir="auto" name="service_name" id="edit-service-title-input"
                                        class="form-control edit-trigger-show d-none" placeholder="Service Name"
                                        type="text">
                                </div>
                                <div class="p-2 bd-highlight">
                                    ...
                                    <div class="ms-auto p-2 bd-highlight">
                                        <div class="dropdown">
                                            <button class="btn btn-warning dropdown-toggle" type="button"
                                                id="review-filter-btn" data-bs-toggle="dropdown" aria-expanded="false">
                                                Filter By
                                            </button>
                                            <ul class="dropdown-menu" aria-labelledby="review-filter-btn">
                                                <li><a class="dropdown-item review-filter-list" data-sort="ASC"
                                                        href="#">Highest
                                                        first</a></li>
                                                <li><a class="dropdown-item review-filter-list" data-sort="DESC"
                                                        href="#">Lowest
                                                        first</a></li>
                                            </ul>
                                        </div>
                            ...
                            <div class="preview-holder">
                                ...
                                <div class="d-flex flex-column bd-highlight mb-3">
                                    ...
                                    <div class="d-inline-flex">
                                        <img class="img-fluid mt-2 me-2"
                                            style="width: 15px;
                                        height: 100%;
                                        top: 13px;"
                                            src="{{ asset('assets/images/icons/location.png') }}" alt="location">
                                ...
                                <div class="d-flex flex-column bd-highlight mb-3">
                                    ...
                                    <span dir="auto"
                                        class="p-2 bd-highlight service-description edit-trigger-display"></span>
                                ...
                                <div class="d-flex flex-column bd-highlight mb-3">
                                    ...
                                    <div class="p-2 bd-highlight">
                                        <div class="container">
                                            ...
                                            <input name="images[]" id="add-images-data-file" type="file"
                                        ...
                                        <div class="d-flex flex-row bd-highlight mb-3">
                                            <div class="p-2 bd-highlight">
                                                ...
                                                <div class="badge bg-secondary d-inline-flex">
                                                    <img src="{{ asset('assets/images/icons/capacity.png') }}"
                                                        alt="..">
                                                    <span
                                            ...
                                            <div class="p-2 bd-highlight">
                                                <p>Available time</p>
                                                <div class="badge bg-secondary d-inline-flex">
                                                    <img src="{{ asset('assets/images/icons/clock.png') }}"
                                                        alt="..">
                                                    <span
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="d-flex flex-row bd-highlight mb-3">
                                                    <div class="bd-highlight w-50">
                                                        <input id="edit-service-min-capacity-input" min="0"
                                                            value="0" placeholder="Minimum" name="min_capacity"
                                                    ...
                                                    <div class="bd-highlight w-50">
                                                        <input id="edit-service-max-capacity-input" min="0"
                                                            value="0" placeholder="Maximum" name="max_capacity"
                                                ...
                                                <div class="col-sm-12 pe-2 ">
                                                    <div class="row">
                                                        <div class="col-sm-6 ">
                                                            ...
                                                            <input id="edit-service-start_available_time-input"
                                                                value="" name="start_available_time"
                                                                class="float-end form-control datepicker-time"
                                                                type="text">
                                                        </div>
                                                        <div class="col-sm-6 ">
                                                            <label class="form-label">Available End time</label>
                                                            <input id="edit-service-end_available_time-input"
                                                                value="" name="end_available_time"
                                                                class="float-end form-control  datepicker-time"
                                                                type="text">
                                                        </div>
                                                        <div class="col-sm-6 ">
                                                            <label class="form-label">Available Date</label>
                                                            <input id="edit-service-start_available_date-input"
                                                                value="" name="available_date"
